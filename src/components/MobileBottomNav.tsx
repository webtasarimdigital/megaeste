  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[100]">
      ...
      <div className="bg-white/85 backdrop-blur-md border-t border-gray-200/50 px-4 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))]">
        <div className="flex w-full max-w-[380px] mx-auto rounded-full shadow-[0_4px_15px_rgba(0,0,0,0.1)] overflow-hidden">
          
          {/* İletişim Button */}
          <a 
            href="tel:+905334814098" 
            className="flex-1 flex justify-center items-center py-[10px] bg-[#4b545c] text-white rounded-l-full z-10 active:bg-[#3a434a] transition-colors"
          >
          ...
          <a 
            ...
            className="flex-1 flex justify-center items-center py-[10px] bg-[#1cb954] text-white rounded-r-full z-10 active:bg-[#18a047] transition-colors"
          >
