      ...
      <div className="p-3 px-4 w-full">
        <div className="flex w-full rounded-full overflow-hidden shadow-sm">
          ...
          >
            ...
            <span className="font-bold text-[17px] tracking-wide">{dict?.contact || "İletişim"}</span>
          </a>
          ...
          >
            <span className="font-bold text-[17px] tracking-wide mr-2">{dict?.whatsapp || "Whatsapp"}</span>
