...
export default function ContactContent({ dict, lang }: { dict?: any, lang: string }) {
  ...
  return (
    <div className="w-full bg-[#f8fafc] pb-10">
      ...
      <section className="relative w-full h-[300px] lg:h-[35vh] min-h-[300px] bg-[#0d2244] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-40 -mt-12 md:-mt-16 lg:-mt-20 w-full max-w-[1280px] mx-auto px-4 lg:px-8">
